...
## Relationship between instant positive test rate and weather

```{r}


write.csv(state_historical_testing_df %>% 
  group_by(state) %>%
  filter(date == max(date)) %>%
  mutate(instant_positive_rate = positiveIncrease / totalTestResultsIncrease,
         positive_rate = positive/  totalTestResults, 
  ...
  select(state, positive, totalTestResults, positive_rate, positiveIncrease, totalTestResultsIncrease, instant_positive_rate,
         instant_positive_trend) %>%
  filter(totalTestResultsIncrease > 100, instant_positive_rate < .75) %>%
  arrange(desc(instant_positive_rate))
, "state_testing.csv")
...
knitr::kable(state_r0_df, 
             ...
             col.names = c("State", "New Cases",  "Total Cases", "Total Deaths", "R0_7", "R0_7 Lag 7", "R0_7 One Week Growth","R0_14", "R0_14 Lag 7",
 "R0_14 One Week Growth"))
...
knitr::kable(state_r0_df_adj, 
             ...
             col.names = c("State", "New Cases", "Total Cases", "Total Deaths", "New Tests", "New Tests L7", "R0_7", "R0_7 Lag 7", "R0_7 One Week Growth","R0_14", "R0_14 Lag 7",
 "R0_14 One Week Growth"))
