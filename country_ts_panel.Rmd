...
cases_7_day_model_us_2 <- lm(lag7_elasticity ~ log(days_since_50),data = covid_ets_state_p)
...
for(i in 1:length(unique(prediction_us$state))) {
  ...
  predict$forecast_new <- round(forecast_forward(predict$new_confirmed, predict$ww_coefficient, 7), digits = 0)
